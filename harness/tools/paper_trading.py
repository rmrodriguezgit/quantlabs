...
class PaperTradingTool(BaseTool):
    ...
    default_rules = {
        ...
        'polymarket_btc_updown': {
            'trade': ['manual_enabled=true', 'mode in observe/paper/live', 'strategy_profile catalog: target_75, five_scalp_conservative, fifteen_confirmed, research_ml, adaptive_5m15m, legacy', 'legacy saneado: filtros minimos defensivos por precio, edge, spread y tiempo a cierre', 'target_75: confidence/edge/ask filters estrictos para buscar mayor precision con baja frecuencia', 'five_scalp_conservative: solo 5m, entradas baratas y edge alto', 'fifteen_confirmed: solo 15m, bloquea si 5m contradice fuerte', 'research_ml: filtros abiertos para observe/paper y dataset', 'spread/ask_size/one_trade_per_event_window'],
