...
class AgentRegistry:
    def __init__(self): self.agents={a.name:a for a in [PlannerAgent(),CodingAgent(),Codex4UAgent(),FileAnalystAgent(),FinanceAgent(),PolymrktAgent(),DexterAgent(),ResearchAgent(),ValidationAgent(),ExecutionAgent()]}
