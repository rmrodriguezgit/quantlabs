...
<script>(()=>{const saved=localStorage.getItem('quantlabs-dashboard-theme');const prefersLight=window.matchMedia&&window.matchMedia('(prefers-color-scheme: light)').matches;document.documentElement.dataset.theme=saved||(prefersLight?'light':'dark');})();</script>
...
<style>:root{--bg:#04000f;--card:#0d0820;--surface:#090514;--border:#1e0f3a;--primary:#00ff99;--accent:#00e5ff;--magenta:#ff00cc;--fg:#fff;--muted:#9a9abb;--line:rgba(255,255,255,.08);--shadow:0 20px 50px rgba(0,0,0,.25)}html[data-theme="light"]{--bg:#f4f7fb;--card:#fff;--surface:#eef3f7;--border:#d6e0e7;--primary:#087f5b;--accent:#0b6bcb;--magenta:#9f2a7b;--fg:#121a23;--muted:#657382;--line:rgba(18,26,35,.1);--shadow:0 16px 34px rgba(21,40,58,.08)}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--fg);font-family:'Syne',sans-serif}header{height:72px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;padding:0 28px;background:color-mix(in srgb,var(--card) 92%,transparent)}.brand{font-weight:800}.brand em{color:var(--primary);font-style:normal}.layout{display:grid;grid-template-columns:240px 1fr;min-height:calc(100vh - 72px)}aside{border-right:1px solid var(--border);padding:24px 14px;background:color-mix(in srgb,var(--card) 74%,transparent)}.nav-label{font:700 10px 'Space Mono';color:var(--muted);text-transform:uppercase;margin:8px 10px}.nav-link{display:flex;gap:10px;color:var(--muted);text-decoration:none;padding:12px;border-radius:12px}.nav-link.active,.nav-link:hover{background:color-mix(in srgb,var(--primary) 12%,transparent);color:var(--fg)}main{padding:34px}.page h1{font-size:32px;margin:0 0 8px}.page h1 span{color:var(--primary)}.sub{color:var(--muted)}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin:24px 0}.card{background:var(--card);border:1px solid var(--border);border-radius:18px;padding:20px;box-shadow:var(--shadow)}.label{font:700 11px 'Space Mono';color:var(--muted);text-transform:uppercase}.value{font-size:24px;font-weight:800;margin-top:8px;color:var(--fg)}.details{display:grid;grid-template-columns:1fr 1fr;gap:16px}.row{display:flex;justify-content:space-between;gap:14px;padding:14px 0;border-bottom:1px solid var(--line)}.row b{color:var(--fg)}.pill{display:inline-block;border:1px solid color-mix(in srgb,var(--primary) 32%,var(--border));background:color-mix(in srgb,var(--primary) 10%,transparent);color:var(--primary);border-radius:999px;padding:5px 10px;font:700 11px 'Space Mono';text-decoration:none}.assets{margin-top:16px}.asset-group{margin-top:16px}.asset-group h4{color:var(--accent);margin:0 0 10px}.chips{display:flex;flex-wrap:wrap;gap:9px}.chip{position:relative}.chip input{position:absolute;opacity:0}.chip span{display:block;padding:9px 12px;border:1px solid var(--border);border-radius:999px;color:var(--muted);cursor:pointer;background:var(--surface)}.chip input:checked+span{color:var(--primary);border-color:color-mix(in srgb,var(--primary) 42%,var(--border));background:color-mix(in srgb,var(--primary) 10%,transparent)}button.save,button.mini{border:1px solid color-mix(in srgb,var(--primary) 35%,var(--border));background:color-mix(in srgb,var(--primary) 12%,transparent);color:var(--primary);border-radius:10px;padding:10px 13px;font-weight:700;cursor:pointer}.msg{margin-left:12px;color:var(--accent)}.asset-form{display:grid;grid-template-columns:1fr 160px 1fr auto;gap:10px;margin:18px 0}.asset-form input,.asset-form select,.asset-row input,.asset-row select{border:1px solid var(--border);background:var(--surface);color:var(--fg);border-radius:10px;padding:11px}.asset-list{display:grid;gap:10px}.asset-row{display:grid;grid-template-columns:1fr 150px 1fr auto auto;gap:10px;align-items:center}.usage-card{margin-top:16px}.usage-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:14px}.usage-kpi{padding:14px;border:1px solid var(--border);border-radius:14px;background:var(--surface)}.usage-kpi strong{display:block;font-size:24px;margin-top:7px;color:var(--fg)}.usage-kpi small{color:var(--muted);font:700 10px 'Space Mono';text-transform:uppercase}.usage-table{width:100%;border-collapse:collapse;margin-top:14px}.usage-table th,.usage-table td{padding:10px 0;border-bottom:1px solid var(--line);text-align:left;color:var(--fg)}.usage-table th{color:var(--muted);font:700 10px 'Space Mono';text-transform:uppercase}.usage-muted{color:var(--muted)}.danger{color:#c92a2a!important;border-color:rgba(201,42,42,.3)!important;background:rgba(201,42,42,.08)!important}.catalog-note{margin-top:18px}@media(max-width:800px){.layout{grid-template-columns:1fr}aside{display:none}.grid,.details,.usage-grid{grid-template-columns:1fr}main{padding:22px}}</style></head>
